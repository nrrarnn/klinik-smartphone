    ...
    <>
      <div className="section-wrapper padding-x pt-32 md:pt-20 pb-10">
        <div className="width-responsif items-center">
          ...
          <p className="pt-3 text-slate-700 text-[14px]">Kami selalu berusaha memberikan yang terbaik untuk setiap pelanggan. Testimoni ini adalah bukti nyata bahwa layanan kami mampu memenuhi harapan mereka.</p>
        </div>
